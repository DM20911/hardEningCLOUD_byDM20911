# AGENTS.md — hardEningCLOUD_byDM20911 (Codex / agentes genéricos)

> Versión para **Codex CLI y agentes compatibles con AGENTS.md**. Colócalo en la raíz del
> proyecto. Donde el texto diga `Read`/`Bash`/`Edit`/`Write`, usa las herramientas equivalentes
> de tu agente (apply_patch / shell / read). Las rutas `references/` y `scripts/` son relativas
> a esta carpeta `local-ai/`.

Activa este modo cuando se pida auditar o endurecer un proyecto en GCP, AWS o Azure.
